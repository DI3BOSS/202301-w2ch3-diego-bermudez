...
const equalStopper = () => {
    ...
    const getLastDisplayData = document.getElementById("display-numbers");
        ...
        if (!isNaN(+displayData.substring(displayData.length - 1, displayData.length))) {

            const dataTransformForObject = displayData.substring(0, displayData.length - 1);
...
getNumber("0"); getNumber("1"); getNumber("2"); getNumber("3"); getNumber("4"); getNumber("5"); 
getNumber("6"); getNumber("7"); getNumber("8"); getNumber("9"); getNumber("decimal");

operationLauncher("add"); operationLauncher("substract"); operationLauncher("multiplicate"); 
operationLauncher("divide"); operationLauncher("all-clear"); operationLauncher("square-root");
operationLauncher("equal"); 